...
import { Doctor, DoctorCreate, DoctorData, DoctorForm, DoctorTable } from "./doctor.type";
import { FirebaseConfig } from "./firebase.type";
import { Appointment, AppointmentData, AppointmentTable, ImagesBlob, ImagesDownloadLink, Patient, PatientData, PatientForm, PatientReferences, PatientTable } from "./patient.type";
